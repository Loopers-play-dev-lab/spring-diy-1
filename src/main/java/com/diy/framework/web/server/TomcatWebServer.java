...
public class TomcatWebServer {
    ...
    public TomcatWebServer(HttpServlet servlet) {
    ...
    private void setDispatcherServlet(Context context) {
        Wrapper sw = this.tomcat.addServlet(context.getPath(), "dispatcherServlet", servlet);
        sw.addMapping("/");
    }
